    ...
    <div className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              Russ Sawyer, a twenty-year United States Air Force veteran, brings unparalleled authenticity to The Hanging Creek Chronicles, a dystopian trilogy tailored for preparedness enthusiasts and post-apocalyptic fiction fans. His latest release, Echoes of Rebellion, raises the stakes as Cole Ramsey's family faces a ruthless corporate tyranny and joins a growing Free States coalition. Inspired by A. American's Going Home series, Russ began this series over ten years ago during dialysis treatments, transforming hardship into a creative pursuit. As a podcast producer for authors in the dystopian genre and preparedness community, he channels his deep survivalist knowledge into narratives of societal breakdown.
              </p>
              <p className="text-lg text-gray-700 font-western mb-6 leading-relaxed">
        ...
        <div className="mb-20">
          ...
          {/* Book 2 - Echoes of Rebellion (New Release) */}
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="lg:order-1">
              <span className="inline-block px-3 py-1 bg-bold-red text-white font-bold font-western text-sm mb-4 tracking-wider">
                NEW RELEASE
              </span>
              ...
              <p className="text-md text-gray-500 font-western italic mb-6">
              Audiobook coming soon on Audible!
              </p>
              <div className="mt-8">
                <a
